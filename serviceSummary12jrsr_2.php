...
//                            }
                    ...
                    echo "</table>";
                    echo "<br/><br/>The following SENIOR students have not entered anything into the database: ";
                    $rowst = getStudents(12);
                    $entered = true;
                    ...
                    echo "</table>";
                    echo "<br/><br/>The following JUNIOR students have not entered anything into the database: ";
