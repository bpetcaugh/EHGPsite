...
dohtml_header("Tutor hours in EHGP");
?>
...
<body>
    ...
    $query = $db->prepare("SELECT * FROM service WHERE (notes LIKE '%uto%' OR notes LIKE '%ibl%') AND verified='1' ORDER BY student ASC");
    $query->execute();//*AND WHERE verified=1
