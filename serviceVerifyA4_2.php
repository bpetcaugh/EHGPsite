    ...
    if ($_SESSION['username'] == $tchdbrow['username'] && $_SESSION['password'] == $tchdbrow['password']) {
        ...
        <script type='text/javascript'>
            function refresh()
            {
                ...
                formObject.action = "serviceVerifyA4_2.php";
                formObject.submit();
            }
        </script>
        ...
        <table class='centered'><td>
                <form name='theForm' method='post' action='serviceVerifyA4_2.php'>
                    ...
                    if (isset($_POST['submit']) && $_POST['submit']) { //problem could be here
                        ...
                        while ($servdbrow1 = $servdb1->fetch()) { //$row = mysql_fetch_array($result)) {
                            ...
                            if (((( (isset($_POST["role" . $i . ""])/* && $_POST["role" . $i . ""] */) || (isset($_POST["verifiedValue" . $i . ""])/* && $_POST["verifiedValue" . $i . ""] */)) || (isset($_POST["hours" . $i . ""])/* && $_POST["hours" . $i . ""] */) ) || (isset($_POST["notes" . $i . ""])/* && $_POST["notes" . $i . ""] */))) {
            ...
            redirect("login_2.php?serviceVerifyA4_2.php");
            //} //if Session
        }//if isset
        $db = null;
//</form>
