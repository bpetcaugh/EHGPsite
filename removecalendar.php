...
<html>
    <center><h1>Remove Calendar Day</h1></center>
    <center>When a calendar day is removed using this utility, letter days and room assignments from this day forward will be shifted forward <br>
        ...
        calendar day. Room assignments from the last calendar day are shifted to the next weekday to be dealt with manually according to circumstances.<br><br></center>
    <table align=center><td><body bgcolor=#CCCCCC>
            <form name=datesRemove action='submit.php' method='post'>
                <?php
