...
dohtml_header("Edit Permit - Admin");
...
<script type='text/javascript'>
    ...
    function refresh()
    {
        ...
        formObject.submit();
        formObject.action = "editppadmin_2.php";
    }
...
<form id='theForm' name='theForm' onsubmit='return validateForm();' method='post' action='submitppadmin_2.php'>
    ...
    <table class='centered'>
        ...
        <tr><td>
                ...
                echo "Student: " . getFullName($sid, $db) . "<br /> StudentID: " . $sid . "</br>";
                ...
                echo "<input type='button' name='cancel' value='Cancel' onclick='self.location=\"viewpp_2.php\"'/>";
                ...
                echo "<input type='hidden' name='oldpermitnumber' value='" . $permitnumber . "'/>";
                echo "<input type='hidden' name='oldverify' value='" . $verify . "'/>";
