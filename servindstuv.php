	...
	<title>Individual Student Service</title>         
        <script type='text/javascript'>
            function refresh()
            {
                ...
                formObject.action="servindstuv.php";
                formObject.submit();
            }
...
<body bgcolor=#CCCCCC>
                ...
                <center><h1>View Verified Service</h1></center>
                <br>
...
//DATABASE DUMP ORDERED BY GRADE: FIRST/LAST/TOTAL SERVICE HOURS
                    ...
                    if (isset($_POST['submit'])) {
						...
						echo "<tr><th>Agency ID</th><th>Agency Name</th><th>Date</th><th>Hours</th></tr>";
                    ...
                    ?>
                            <tr>
                                <td><?php echo $servdbrow['agency']; ?></td>
						...
						echo "  <br><br>Note that some service may not yet be verified. The student must also submit a ";
						echo " Service Verification Form to Mr. Fitzpatrick in addition to entering their service online.";
						echo "<br><br>Choose the 'View Reported Service' button to see all the service hours reported ";
						echo "by the student for approval toward required hours.<br><br>";
                        echo "</table>";
                    }
                        ?>
                </form>
                <?php
                    ...
                    redirect("login.php?ServiceAgencies");
                }
            } else {
				redirect("login.php?ServiceAgencies");
            }
