...
?>
            ...
            <head>
                ...
                <script type='text/javascript'>
                    function refresh()
                    {
                        ...
                        formObject.action="serviceVerifyS4b.php";
                        formObject.submit();
                    }
                    function homepage()
                    {
                        window.location = 'http://electronichgp.holyghostprep.org'; //redirects to homepage
                    }
        ...
        echo " ";
        //test remove
        echo "<br /><center>Data for Student ID#: " . $_POST['stid'] . "</center>"; // . " " . $_POST['lastname'] . ", " . $_POST['firstname'];
        ?>
        <br>
        <table align=center><td>
                ...
                redirect("login.php?serviceVerifyS4b.php");
                //} //if Session
            }//if isset
            $db = null;
                    ?>
