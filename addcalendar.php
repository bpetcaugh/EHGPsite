...
<html>
    <center><h1>Add Calendar Days</h1></center>
    <center>Calendar days added using this utility will automatically be assigned letter days based on input and room schedulings<br>
        based on the autoroomschedule database table. Weekends are automatically skipped; other skip days must be added to the list below.</center><br>
    <table align=center><td><body bgcolor=#CCCCCC><form name=datesAdd action='submit.php' method='post'>
                <?php
