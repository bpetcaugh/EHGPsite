    ...
    <head>
        <script type='text/javascript'>
            ...
            function refresh()
            {
                ...
                formObject.submit();
                formObject.action = "editppstudent.php";
            }
            ...
            function cancel()
            {
                window.location.href = "http://advancedtopics.holyghostprep.org/advancedtopics/vpillinger/ehgp/viewmypermit.php";
            }
        </script>
    </head>
    <body bgcolor='#CCCCCC'>
    ...
    <table align='center'>
        <td>
            <form id='theForm' name='theForm' onsubmit='return validateForm();' method='post' action='submitpp.php'>
                ...
                <input type='button' name='cancel' value='Cancel' onclick='self.location = "viewmypermit.php"'/><br/><br/>
            </form>
