...
?>
		...
		<script type='text/javascript'>
            function refresh()
            {
                ...
                formObject.action="serviceVerify_2.php";
                formObject.submit();
            }
        </script>
...
?>		
		...
		<form name='theForm' method='post' action='serviceVerify_2.php'>
<?php 
...
<?php //echo //$row3['name']
		...
		echo "<br>" . $servdbrow2['notes']."<br><br>";
...
<?php
        ...
        redirect("login_2.php?serviceVerify_2.php");
	} //if Session
	}//if isset
$db = null;
echo "</td></table>";
