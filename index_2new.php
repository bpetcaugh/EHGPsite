...
if (check_logged_in()) {
    ...
    if (is_admin($_SESSION['username'], $_SESSION['password'])) { //changed by CK 2/2014, mmm 7-25-15 
		makeButton("Administrator Tools","indexAdmin_2.php");//added 7-24-15 mmm
	}	
	...
	if ($isTeacher){ 
		...
		makeTwoButtons("Test Calendar","login_2.php?test=1","View Parent-Teacher Schedule","parteach-ts_2.php");//added 10-08-14 to fix CK erasing it under Jacobs supervision!!!	
			...
			makeButton("Bell Schedules","bellschedules.html");
			tableRowSpace();
			insertInRow("Parent-Teacher Night Appointment Signup");//makeButton("Parent-Teacher Night Signup","par-teach-night_3.php");
