...
//       echo "<br><font size=6><center>" . date('l', strtotime($date)) . ", " . date('F jS', $tomorrow) . "</center></font></td>";
  //     echo "</tr></table><hr>";
		...
		echo "<center><font size=4>Daily Announcements for " .  date('l', strtotime($date)) . ", " . date('F jS', $tomorrow)  . " -- To: " . $row['grade'] . " -- From: " . $row['teacher'] . "<br /></font><br /><font size=5>";
...
?>
<script>setTimeout("location.href = 'scrollingsignageXMAS.php?num=<?PHP
