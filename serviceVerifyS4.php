...
?>
            ...
            <head>
                ...
                <script type='text/javascript'>
                    function refresh()
                    {
                        ...
                        formObject.action="serviceVerifyS4.php";
                        formObject.submit();
                    }
                </script>
        ...
        echo " ";
        //test remove
        echo $_POST['stid'] . " " . $_POST['lastname'] . ", " . $_POST['firstname'];
        ?>
        <br>
        <table align=center><td>
                <form name='theForm' method='post' action='serviceVerifyS4.php'>
                    ...
                    if (isset($_POST['submit']) && $_POST['submit']) { //problem could be here
                        ...
                        $sql2 = "SELECT * FROM service WHERE verified=:verified AND stid=:stid ORDER by date";
                    ...
                    if ($stidsel != 0) {
                        ...
                        $servdb3 = $db->prepare("SELECT * FROM service WHERE verified = :verified AND stid = :stid ORDER by date");
                ...
                redirect("login.php?serviceVerifyS4.php");
                //} //if Session
            }//if isset
            $db = null;
//</form>
