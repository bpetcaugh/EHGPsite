...
dohtml_header('Service Summary for Seniors');
serv_admin_only();
password_protect();
...
//$rows = getService();
					...
					foreach ($rowst2 as $row2) {
                        ...
                        if (($tshv > 20) && ($cn >= $sryrcn) && ($cn < ($sryrcn + 1000))) {
                            $overmin=$overmin+1;
							$tshvsum=$tshvsum+$tshv;
							echo "<tr><td>" . $name . "</td><td>" . $tshv;
                            echo "</td></tr>";
                        }
                    }
					echo "<tr><td>Number of seniors over minimum: " . "</td><td>" . $overmin;
                    echo "</td></tr>";
					echo "<tr><td>Total number of senior service hours: " . "</td><td>" . $tshvsum;
                    echo "</td></tr>";
                    echo "</table>";
                }
                ?>
