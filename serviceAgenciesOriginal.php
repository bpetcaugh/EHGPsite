...
<head>
        <script type='text/javascript'>
            function refresh()
            {
                ...
                formObject.action="serviceAgencies.php";
                formObject.submit();
            }
...
<body bgcolor=#CCCCCC>
                ...
                <table align=center><td>
                    ...
                    $stha = $db->prepare("SELECT * FROM agencies");
   					$stha->execute();
...
//DATABASE DUMP ORDERED BY GRADE: FIRST/LAST/TOTAL SERVICE HOURS
                    ...
                    ?>
						...
						echo "Students have volunteered " . $i . " times performing a total of " . $totalhours . " hours.<br><br>";
                        echo "</table>";
                    }
                        ?>
                </form>
