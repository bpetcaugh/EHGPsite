...
teacher_only();
password_protect("login.php?dress=1");
...
<script type='text/javascript'>
    function refresh()
    {
        ...
        formObject.action="adddress.php";
        formObject.submit();
    }
    function send()
    {
...
<body bgcolor=#CCCCCC>
    <h1 align=center>Add Dress Code Violation</h1>
    <table align=center><td><form name='theForm' method='post' action='submit.php'>
                ...
                do {
                    ...
                    if (isset($_POST[$name])) {
                        ...
                        echo "<option value='Frayed Pants' ";
