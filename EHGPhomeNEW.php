...
<form action='https://ehgp.holyghostprep.org/announcements.php' style='display:inline-block'><input style='display:inline-block' type='submit' class='btn btn-primary announcements-btns' value='Announcements'></form>

<form action='https://ehgp.holyghostprep.org/BellSchedules.pdf' style='display:inline-block'><input style='display:inline-block' type='submit' class='btn btn-primary announcements-btns' value='Bell Schedules'></form>
		
<form action='https://ehgp.holyghostprep.org/scheduleViewS_2.php' style='display:inline-block'><input style='display:inline-block' type='submit' class='btn btn-primary announcements-btns' value='Computer Lab Usage'></form>
		
<form action='https://ehgp.holyghostprep.org/login_2.php?home=1' style='display:inline-block'><input style='display:inline-block' type='submit' class='btn btn-primary announcements-btns' value='Login'></form>
<p></p>
