...
if($row = mysql_fetch_array($result))
{
	...
	{	
		...
		echo "<br><br><font size=6>From: " . $row['teacher'] . "<br>";
		echo "To: " . $row['grade'] . "</font><br><br><font size=5>";
		echo ($row['announcement']) . "</font><br><br>"; //deleted n12br beginning
}
else
...
?>
<script>setTimeout("location.href = 'scrolling.php?num=<?PHP
...
?>
<br><br>
<font size=1>Designed by Mr. Jacobs and Joe Wolfe</font>
</table>
</body>
</html>