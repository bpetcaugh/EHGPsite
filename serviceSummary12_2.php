...
//        echo "<center>&nbsp&nbsp<a href=logout.php>Logout</a></center><br><br>";
        ...
        ?>
        <br>
        <table class='centered'><td class='centered'>
                ...
                <?php { //of if SUBMIT
                    ...
                    foreach ($rows as $row) {
                        ...
                        echo "<tr class='centered'><td class='centered'>" . $name . "</td><td class='centered'>" . $sh . "</td><td class='centered'>" . $sdt . "</td><td class='centered'>" . $agency . "</td><td class='centered'>" . $nts . "</td><td class='centered'>" . $role . "</td><td class='centered'>" . $verified . "</td><td class='centered'>" . $tshv;
                        echo "</td></tr>";
                    }
                    echo "</table>";
