...
$hourMessage = "For service performed at the same site on multiple days, " + "\n";
$hourMessage = $hourMessage + "total the hours and enter them here. Be sure to submit ";
$hourMessage = $hourMessage + "the required Service Verification Form to Mr. Fitzpatrick.";
echo "\t\t<a onMouseOver='alert(" . $hourMessage . ")'>Can I total hours performed on different dates at the same site?</a><br><br>";
...
$dateMessage = "For service performed at the same site on multiple days, " + "\n";
$dateMessage = $dateMessage + "you need only enter the last date service was performed.";
echo "\t\t<a onMouseOver='alert(" . $dateMessage . ")'>If service is performed at the same site on multiple days, do I need to enter every day?</a><br><br>";
